      ...
      <div className="formPage flex items-center justify-center bg-  flex-col">
        <div className="form-container shadow-xl pr-10 pl-10 pb-4 w-[50rem]">
          ...
          <div className="product-dimension">
            <h1 className="font-bold capitalize pt-3">product Dimension</h1>
            <div className="details capitalize">
              <Input
                label="Purity"
                type="text"
              ...
              <Input
                ...
                onChange={handleFormChange}
              />
              <Input label="cut" type="text" name="cut" value="" onChange="" />
              <Input
                label="color"
                type="text"
                name="color"
          ...
          <div className="foot grid grid-cols-2 gap-2 capitalize">
            <Input label="rate" type="text" name="rate" value="" />
            ...
            <div className="flex items-center flex justify-around">
              ...
              <Input label="after tax" type="checkbox" />
            </div>
                  </div>
                  <button className="flex justify-self-end bg-slate-400 p-2 pr-5 pl-5 mt-4 mr-[8rem] text-white">active/deactive</button>
        </div>
      </div>
    </>
  );
